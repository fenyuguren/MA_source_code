...
{
public:
	vector<int>CDS(vector<vector<int>> ptime);
	void SchedulingJobsinFam(vector<vector<int>> &JobSeqinFam);
	int CalculateMakespan(vector<int>Seq, vector<vector<int>> ptime);
